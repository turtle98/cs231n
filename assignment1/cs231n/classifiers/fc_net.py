...
class TwoLayerNet(object):
    ...
    def __init__(
        ...
        mu, std = 0, weight_scale 
        w1 = np.random.normal(mu, std, (input_dim,hidden_dim))
        bias1 = np.zeros(hidden_dim)
        w2 = np.random.normal(mu, std, (hidden_dim, num_classes))
    ...
    def loss(self, X, y=None):
        ...
        delta1, grads['W2'], grads['b2'] = affine_backward(delta, cache3)
        delta2 = relu_backward(delta1, cache2) 
        delta3, grads['W1'], grads['b1'] = affine_backward(delta2, cache1)
